...
public class LoggerButtons : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        BigLogger.InitializeNewLogging(logName); // Tell the primary static class to save its old data and create new ones
    }
    ...
    void Update()
    {
        ...
        if (Input.GetKeyUp("space"))
        {
            ...
            if (Mathf.Abs(buttonHoldEndTime - buttonHoldStartTime) > BigLogger.threshold) { BigLogger.SaveButtonPress(buttonHoldStartTime, buttonHoldEndTime - buttonHoldStartTime, "spacebar"); } // If the duration is not 0, log this button press
        }
    ...
    public void ButtonReleasedLog(int index, string otherButtonName)
    {
        ...
        if (Mathf.Abs(buttonHoldEndTime - buttonHoldStartTime) > BigLogger.threshold) { BigLogger.SaveButtonPress(buttonHoldStartTime, buttonHoldEndTime - buttonHoldStartTime, "downarrow"); } // Log down arrow if the press was longer than 0 s
    }
